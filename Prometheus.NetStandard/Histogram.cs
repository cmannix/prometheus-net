...
namespace Prometheus
{
    ...
    public class Histogram : Collector<Histogram.Child>, IHistogram
    {
        ...
        {
            CheckArgument(count > 0, $"{nameof(ExponentialBuckets)} needs a positive {nameof(count)}");
            CheckArgument(start > 0, $"{nameof(ExponentialBuckets)} needs a positive {nameof(start)}");
            CheckArgument(factor > 1, $"{nameof(ExponentialBuckets)} needs a {nameof(factor)} greater than 1");
        ...
        {
            CheckArgument(count > 0, $"{nameof(LinearBuckets)} needs a positive {nameof(count)}");
